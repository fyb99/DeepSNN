...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    tr_transforms.append(RenameTransform('ctu', 'ctu_target', True))

    if regions is not None:
        tr_transforms.append(ConvertSegmentationToRegionsTransform(regions, 'target', 'target'))
        tr_transforms.append(ConvertSegmentationToRegionsTransform(regions, 'ctu_target', 'ctu_target'))
    ...
    tr_transforms.append(NumpyToTensor(['data', 'target', 'ctu_target'], 'float'))
